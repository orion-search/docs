---
id: running_etl
title: Running Orion's ETL
sidebar_label: Running Orion's ETL
---
...
<img alt="docker-compose" src={useBaseUrl('img/airflow-log.png')} />
...
<img alt="Airflow UI" src={useBaseUrl('img/airflow-ui-on.png')} />
...
<img alt="Airflow  DAG" src={useBaseUrl('img/airflow-dag.png')} />
...
<img alt="Sucessful tasks" src={useBaseUrl('img/airflow-successful-tasks.png')} />
